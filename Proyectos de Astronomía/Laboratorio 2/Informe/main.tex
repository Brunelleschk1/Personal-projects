...
Si el informe se refiere a este análisis como exactamente lo que se esperaba, es porque es exactamente lo que se esperaba: un cúmulo con miembros 
faltantes, dando lugar a la necesidad de un nuevo método de análisis de cuerpos celestes para poder determinar su presencia a un cúmulo. 
Es, sin embargo, más interesante en el caso particular de este informe, hablar de lo extraño del caso: un cúmulo de más de 500 estrellas 
en una región del cielo que supuestamente es cercana a la dirección de Messier 41, pero que solo comparte una estrella con la región de
dicho cúmulo. ¿Qué causa que una región del cielo tenga tal densidad de estrellas con tanta probabilidad de pertenencia? 
¿O será simplemente una coincidencia en los parámetros de PM? 
